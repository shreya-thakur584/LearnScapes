...
function goFurther(){
  if (document.getElementById("chkAgree").checked == true) {
    document.getElementById('btnSubmit').style = 'background: linear-gradient(to right, #FA4B37, #cc23ff);';
  }
  else{
...
function display(n) {
  ...
  s1.style = 'background: #cc23ff; color: #FFF;';
  s2.style = 'background: #cc23ff; color: #FFF;';
  s3.style = 'background: #cc23ff; color: #FFF;';
  s4.style = 'background: #cc23ff; color: #FFF;';

  if(n==1) {
    img1.style = 'display: block;';
    s1.style = 'background: #E5E8EF; color: #cc23ff;';
  }
  if(n==2) {
    img2.style = 'display: block;';
    s2.style = 'background: #E5E8EF; color: #cc23ff;';
  }
  if(n==3) {
    img3.style = 'display: block;';
    s3.style = 'background: #E5E8EF; color: #cc23ff;';
  }
  if(n==4) {
    img4.style = 'display: block;';
    s4.style = 'background: #E5E8EF; color: #cc23ff;';
  } 
}
